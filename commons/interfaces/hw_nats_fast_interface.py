from .base_fast_interface import *
from ..utils import get_project_root
from typing import Set
from itertools import chain
import numpy as np

class HW_NATS_FastInterface(Base_FastInterface):
    
    def __init__(self, 
                 datapath:str=str(get_project_root()) + "/searchspaces/hw_nats_interface_dataset.json", 
                 indexpath:str=str(get_project_root()) + "/searchspaces/nats_arch_index.json",
                 dataset:str="cifar10", 
                 device:Text="edgegpu"):
        
        AVAILABLE_DATASETS = ["cifar10", "cifar100", "ImageNet16-120"]
        AVAILABLE_DEVICES = ["edgegpu", "raspi4", "edgetpu", "pixel3", "eyeriss", "fpga"]
        # catch input errors
        ...
        # parent init
        super().__init__(datapath=datapath, indexpath=indexpath)
        # store dataset field
