...
class HW_FreeRENAS_RecombinationEnv(FreeRENAS_RecombinationEnv):
    """
    gym.Env for the Hardware aware FreeRENAS with Recombination algorithm, i.e. a RENAS-like algorithm 
    using Training-Free metrics and oriented to solve the NAS problem via only performing recombinations
    rather than mutations hardware.
    ...
    @property
    def name(self)->Text:
        return "hwfreerenas-recombination"
