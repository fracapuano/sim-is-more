...
Edit: Originally defined in https://github.com/GATECH-EIC/HW-NAS-Bench, this implementation offers a more
interpretable and better structured API for HW-NAS-Bench.

In keeping with open-source spirit, the changes made here and implemented, will be submitted as a pull request
to the original repository.
"""
import pickle
from ..network_utils import get_project_root

class HWNASBenchAPI:
    def __init__(self, 
                 file_path_or_dict:str=str(get_project_root()) + "/searchspaces/HW-NAS-Bench-v1_0.pickle", 
